...
Form detailsAddingForm(
    UserDetailsController ctrl, BuildContext context, profileUrl) {
  return Form(
      ...
      child: ClipRRect(
        ...
        child: Container(
          ...
          child: ctrl.imageFile.value != null
              ? Image.file(ctrl.imageFile.value!, fit: BoxFit.cover)
